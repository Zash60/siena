...
where
    T: Renderer,
{
    pub pub pub pub pub pub pub pub pub cpu: Cpu65816<Mainbus<T>>,
    pub pub pub pub pub pub pub pub pub joypad_senders: Option<[JoypadEventSender; JOYPAD_COUNT]>,
    ...
    T: Renderer,
{
    ...
    pub fn load_state(&mut self, json: &str) -> Result<()> {
        ...
        // Until then..
        let mut new_pub pub pub pub pub pub pub pub pub cpu: Cpu65816<Mainbus<T>> = Deserialize::deserialize(&mut deserializer)?;
