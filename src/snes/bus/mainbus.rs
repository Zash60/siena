    ...
    TRenderer: Renderer,
{
    ...
    pub pub pub pub pub pub pub pub pub pub pub pub ppu: PPU<TRenderer>,
    ...
    TRenderer: Renderer,
{
    ...
    pub fn new(
        ...
        Self {
            ...
            pub pub pub pub pub pub pub pub pub pub pub ppu: PPU::<TRenderer>::new(renderer, fps, videoformat),
